      ...
      <div className="flex">
        ...
        {showMobileMenu && (
          <div className="lg:hidden fixed inset-0 z-50">
            ...
            />
            <div 
              className={`absolute left-0 top-0 h-full w-80 bg-white dark:bg-gray-800 transition-colors duration-200 transform transition-all duration-300 ease-out ${
...
export default Parametresimport { useState, useEffect } from 'react'
import { useAuth } from '../context/AuthContext'
import { useNavigate } from 'react-router-dom'
import { useTheme } from '../context/ThemeContext'
import LeftSidebar from './LeftSidebar'
